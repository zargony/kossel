...
M665 R124.71 L242.20 B80 H258.67 X-0.46 Y-0.58 Z0.0	; set delta radius, diagonal rod length, printable radius and homed height
M666 X0.95 Y-0.07 Z-0.88			; put your endstop adjustments here, or let auto calibration find them
...
G31 X0 Y0 Z1.12 P500				; Set the zprobe height and threshold (put your own values here)
